...
export default function Sub5Component({회원가입, confirmModalOpen,isConfirmModal, addressSearchOpen, 주소1, 주소2 }) {
    ...
    const onClickIdOkBtn=(e)=>{
        ...
        if( regExp.test(아이디)===false ){
            ...
            axios({
                url:'http://moonjong.dothome.co.kr/kurly10/select_id_check.php',
                method:'POST',
    ...
    const onClickEmailOkBtn=(e)=>{
        ...
        if( 이메일==="" ){
            ...
            axios({
                url:'http://moonjong.dothome.co.kr/kurly10/select_email_check.php',
                method:'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickChoochunId=(e)=>{
        ...
        axios({
            url:'http://moonjong.dothome.co.kr/kurly10/select_choochun_id_check.php',
            method:'POST',
            data: formData
        })
        .then((res)=>{
    ...
    const onSubmitSignup=(e)=>{
        ...
        if( 아이디 ===  ""){
            ...
            axios({
                url:'http://moonjong.dothome.co.kr/kurly10/signup.php', // 서버사이드 스크립트 언어 파일  signup.php
                method:'POST',
                data: formData
            })
            .then((res)=>{
